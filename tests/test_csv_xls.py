...
from tinybear.txt import read_plain_text_from_file
...
def test_convert_xls_to_csv():
    ...
    path_to_gold_standard_csv_file = (
        DIR_WITH_TEST_FILES / "test_convert_excel_to_csv_gold_standard.csv"
    )
...
def test_read_column_from_csv():
    file = DIR_WITH_TEST_FILES / "doculects_output_gold_standard.csv"
...
def test_check_csv_for_malformed_rows_throws_exception_for_malformed_rows():
    file = DIR_WITH_TEST_FILES / "csv_doculects_with_incomplete_rows.csv"
...
def test_check_csv_for_repetitions_in_column_throws_error_with_repetition_in_column():
    file = DIR_WITH_TEST_FILES / "csv_doculects_with_duplicate_values.csv"
...
def test_read_dicts_from_xls_reads_good_file():
    dicts = read_dicts_from_xls(DIR_WITH_TEST_FILES / "feature_profile_belarusian.xlsx", "Лист1")
...
def test_read_dicts_from_xls_raises_exception_with_bad_sheet_name():
    with pytest.raises(KeyError):
        read_dicts_from_xls(DIR_WITH_TEST_FILES / "feature_profile_belarusian.xlsx", "foo")
...
def test_append_empty_column_to_csv_adds_new_column():
    input_file = DIR_WITH_TEST_FILES / "doculects_output_gold_standard.csv"
    output_file = DIR_WITH_TEST_FILES / "append_empty_column_doculects_output.csv"
    gold_standard_file_after_append = (
        DIR_WITH_TEST_FILES / "append_empty_column_doculects_gold_standard.csv"
    )
...
def test_append_empty_column_to_csv_raises_exception_with_existing_custom_output_file():
    input_file = DIR_WITH_TEST_FILES / "doculects_output_gold_standard.csv"
    existing_file = DIR_WITH_TEST_FILES / "append_empty_column_doculects_gold_standard.csv"
    with pytest.raises(FileExistsError):
        append_empty_column_to_csv(
            path_to_file=input_file,
